...
```json
{
  "upgrade": {
    "available": true,
    "version": "v1.0.1",
    "url": "https://<panel>/api/agent/binary/xpayincus-agent-linux-amd64?v=v1.0.1",
    "sha256": "<sha256>",
    "gzip": false
  }
}
...
```text
dist/xpayincus-agent-linux-amd64
dist/xpayincus-agent-linux-arm64
dist/manifest.json
```
...
tag: agent-v0.0.1
assets:
  xpayincus-agent-linux-amd64
  xpayincus-agent-linux-arm64
```
...
```text
https://<panel>/api/agent/binary/xpayincus-agent-linux-amd64
https://<panel>/api/agent/binary/xpayincus-agent-linux-arm64
```
